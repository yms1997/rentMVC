...
<script type="text/javascript" src="scripts/RentCarRegister.js" defer></script>
				...
				<div>
					<table class="upload-table">
						...
						<tr>
							<td>차량분류</td>
							<td class="radio-td">
								<input type="radio" name="category" value="1" class="fv" checked /> 소형 &nbsp;
						...
						<tr>
							<td>승차 인원</td>
							<td><input class="fv" type="number" name="usepeople" value="4" /></td>
						</tr>
						<tr>
							<td>재고 수량</td>
							<td><input class="fv" type="number" name="total_qty" value="3" /></td>
						</tr>
						<tr>
							<td>제조 회사</td>
